...
<div id="container" class="container">
	...
	<ul>
        ...
        <li style="background-color:#8C8C8C;" class="fontpx"><a style="color: #000000" href="patient diagnose second drag.php">药物配给</a></li>
        </ul>
	...
	<h2>药物配给</h2>
	<form action="patient diagnose second drag.php" method="post">
