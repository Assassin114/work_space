...
<div id="container" class="container">
	...
	<ul>
        ...
        <ul>
        <li class="fontpx"><a href="patient diagnose third sign.php">各项体征</a></li>
        <li style="background-color:#8C8C8C;" class="fontpx"><a style="color: #000000" href="patient diagnose third result.php">诊断结果</a></li>
	...
	<form action="patient diagnose third result.php" method="post">
...
<?php
	if(isset($_POST["submit"]) && $_POST["submit"] == "保存并提交")
	{
		...
		if($illness_outline != "请选择疾病纲目" and $illness != "请选择疾病科目")
		{
			...
			$sql = "update third_diagnosis set illness_outline = '$illness_outline', illness = '$illness',suggest1 = '$suggest1',suggest2 = '$suggest2', suggest3 = '$suggest3', suggest4 = '$suggest4' where username = '$username' and number = '$_SESSION[time]'";
			$res = mysql_query($sql);
			if($res)
			{
				echo("<script>alert('提交成功！');window.location.href='patient diagnose third drag.php';</script>");
			}
			else
			{
