...
<div id="container" class="container">
	...
	<ul>
        ...
        <li style="background-color:#8C8C8C;" class="fontpx"><a style="color: #000000" href="patient diagnose forth result.php">最终结果</a></li>
	...
	<form action="patient diagnose forth result.php" method="post">
...
<?php
	if(isset($_POST["submit"]) && $_POST["submit"] == "保存并提交")
	{
		...
		if($illness_outline != "请选择疾病纲目" and $illness != "请选择疾病科目")
		{
			...
			$sql = "update forth_diagnosis set illness_outline = '$illness_outline', illness = '$illness',suggest1 = '$suggest1',suggest2 = '$suggest2', suggest3 = '$suggest3', suggest4 = '$suggest4' where username = '$username' and number = '$_SESSION[time]'";
			$res = mysql_query($sql);
			if($res)
			{
				echo("<script>alert('提交成功！');window.location.href='patient diagnose forth drag.php';</script>");
			}
			else
			{
